...
\033[1;36m$$ /  $$ |\$$\ $$  / $$ |  $$ |$$ /  \__|$$ |  $$ |
\033[1;36m$$$$$$$$ | \$$$$  /  $$ |  $$ |\$$$$$$\  $$$$$$$$ |
\033[1;36m$$  __$$ |  \$$  /   $$ |  $$ | \____$$\ $$  __$$ |
\033[1;36m$$ |  $$ |   $$ |    $$ |  $$ |$$\   $$ |$$ |  $$ |
\033[1;36m$$ |  $$ |   $$ |    \$$$$$$  |\$$$$$$  |$$ |  $$ |
\033[1;36m\__|  \__|   \__|     \______/  \______/ \__|  \__|                                                                                                                                                     
...
\033[1;36m$$/   $$/ $$$$$$$/  $$/   $$/ $$$$$$/                                                                                                                                                                                                                                                                                                                                         
\x1b[1;30m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN : ABHI X SIYA
\033[1;37m▇==➤ GITHUB : ABHI XWD
\033[1;31m▇==➤ CREATOR : ABHI X SIYA 
\033[1;37m▇==➤ FACEBOOK : ABHI SHARMA
\x1b[1;30m════════════════════════════════════════════════════════
...
════════════════════════════════════════════════════════""")
                ...
                whatsapp = "+918949323859"
                url_wa = "https://api.whatsapp.com/send?phone="+whatsapp+"&text="
                tks = ("Hello The Abhi x3 siya queen , I Need To Buy Your Paid Tools Please Approve My Key :)\n\n Key :- "+key)
...
testPY()
print('''\033[1;32m.═════════RUL3X═>CHOD══════ABHI-XWD════════════════════════════════════════\n''')
def venom():
    clear = "\x1b[0m"
    colors = [35, 33, 36]
    ...
    y = '''
\033[1;33m════════════════════════════════════════════════════════
\033[1;31m L1F3 L1N3   \033[1;34m: \033[1;33mABHI X3 SIYA
\033[1;36m 9BHII X3 SIY9  \033[1;35m: \033[1;34mABHI X3 SIYA    
\033[1;31m OWN3R   \033[1;36m: \033[1;35mABHI X SIYA
\033[1;36m Contact \033[1;33m: \033[1;36m+918949323859
\033[1;33m════════════════════════════════════════════════════════
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                print (e.strftime("--> XM9RTY ABHII K1NG :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
                print("--> Message Successfully Sent By TH3 L3G3ND BOY ABHI SHARMA♻️ :D ::-->> ", message, "\n")
                print('''\033[1;33m════════════════════════════════════════════════════════\n''')
                time.sleep(timm)
            else:
...
\033[1;36m $$$$$$/  $$$$$$/     $$/    $$/   $$/                                                                                                                                                                                                                                                                                                                                                              
\x1b[1;34m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN       : ABHI SHARMA
\033[1;32m▇==➤ GITHUB       : ABHI XWD
\033[1;30m▇==➤ OWNER       : ABHI X SIYA
\033[1;32m▇==➤ FACEBOOK   : ABHI XWD
\033[1;37m════════════════════════════════════════════════════════""")
    os.system('espeak -a 300 "ABHII KA LUND DAL BOSDIKE"')
